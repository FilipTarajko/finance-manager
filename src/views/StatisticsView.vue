...
<template>
  <h1>Statistics</h1>
  positive transactions: {{ positiveTransactionsInstances }}
  <br />total gains: {{ positiveTransactionsGain }}
  <br />negative transactions: {{ negativeTransactionsInstances }}
  <br />total losses: {{ negativeTransactionsLosses }}
  <br />total transactions: {{ totalTransactionsInstances }}
  <br />total difference: {{ totalTransactionsSum }}
